 ...
 * (Gemini, Groq, and OpenRouter) simultaneously.
 *
 * Unlike buildBowPipeline (Gemini-only), this includes Groq and OpenRouter
 * models so they can race alongside Gemini during BOW extraction.
 *
 * @param {Object} params
 * @param {string} params.geminiApiKey
