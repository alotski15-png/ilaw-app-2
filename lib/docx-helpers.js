...
export const buildSessionTable = async ({ lessonPlan, snapshotData, sessionIndex, sessionLabel, headerBannerStyle = {} }) => {
  ...
  const sessionTable = new Table({
    ...
    rows: [
      ...
      new TableRow({ children: [await createCell('Learning Area:', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }), await createCell(formatDocxText(lessonPlan.header?.learningArea || snapshotData?.subject), { colSpan: 3, widthMm: 144.8, borderColor: matrixBorder, cellMargins: matrixMargins, fontSize: 24 })] }),
      new TableRow({ children: [await createCell('Name of Teachers:', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }), await createCell(formatDocxText(getOnlyName(lessonPlan.header?.teacherName || snapshotData?.teacherName)), { colSpan: 3, widthMm: 144.8, borderColor: matrixBorder, cellMargins: matrixMargins, fontSize: 24 })] }),
      new TableRow({ children: [await createCell('Grade level & Section:', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }), await createCell(formatDocxText(lessonPlan.header?.gradeLevelSection || snapshotData?.gradeAndSection), { colSpan: 3, widthMm: 144.8, borderColor: matrixBorder, cellMargins: matrixMargins, fontSize: 24 })] }),
      new TableRow({ children: [await createCell('No. of Sessions:', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }), await createCell(`${snapshotData?.noOfSessions || ''} (${sessionLabel})`, { colSpan: 3, widthMm: 144.8, borderColor: matrixBorder, cellMargins: matrixMargins, fontSize: 24 })] }),
      new TableRow({
        children: [
          await createCell('References:\nbooks, websites, toolkits, etc.', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }),
      ...
      new TableRow({
        children: [
          await createCell('Declaration of AI Use:\nCite how AI was used in the formulation of the lesson plan.\nSee DO no. 3 s. 2026', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }),
      ...
      new TableRow({
        children: [
          await createCell('Learning Objectives:\nWrite the smaller knowledge, skills, or tasks from the competency that the learners will work on and be able to show by the end of the sessions.', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }),
          await createCell(objectives, { colSpan: 3, widthMm: 144.8, borderColor: matrixBorder, cellMargins: matrixMargins, fontSize: 24 })
        ]
      }),
      new TableRow({
        children: [
          await createCell('Learner Context:\nWrite your observation of your learners, and how they have been performing or responding to learning experiences recently. Include strengths, interests, and possible barriers to learning.', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }),
      ...
      new TableRow({
        children: [
          await createCell('Formative Assessment:\nCreate a task, activity, or questions to assess learning and provide feedback every now and then. Include ways for learners to ask for guidance or support throughout each session.\nRemember to provide appropriate accommodations so all learners can demonstrate their understanding (e.g., varied response formats, small group options, visual or auditory supports)', { bold: true, widthMm: 45.2, labelSize: 28, fontSize: 28, borderColor: matrixBorder, cellMargins: matrixMargins }),
